...
function Contact() {
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "bhargavpavuluri13@gmail.com",
      href: "mailto:bhargavpavuluri13@gmail.com",
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      label: "Phone",
      value: "+1 (470) 354-4337",
      href: "tel:+14703544337",
    },
    {
      icon: (
  ...
  return (
    <section id="contact" className="bg-gray-900 text-white py-24 px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-xl mx-auto">
            Open to full-time opportunities, collaborations, and interesting projects. Drop me a
            ...
            <div className="space-y-5 mb-10">
              {contactInfo.map((item, i) => (
                <a
                  ...
                  className="flex items-center gap-4 bg-gray-800 p-4 rounded-xl border border-gray-700 hover:border-blue-500 transition-colors duration-300 group"
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-blue-600/20 text-blue-400 rounded-lg flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                    {item.icon}
                  </div>
                  <div>
