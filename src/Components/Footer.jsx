  ...
  return (
    <footer className="bg-black border-t border-gray-800 text-white">
      ...
      <div className="max-w-6xl mx-auto px-8 py-12 grid md:grid-cols-3 gap-10">
        ...
        {/* Quick Links */}
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-4">Quick Links</h4>
        ...
        {/* Contact & Socials */}
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-widest text-gray-400 mb-4">Connect</h4>
          <div className="flex gap-4 mb-6">
            {socialLinks.map(({ label, href, icon }) => (
              <a
                ...
                aria-label={label}
                className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-colors duration-300"
              >
                {icon}
              </a>
            ))}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-2 rounded-lg transition-colors duration-300"
          >
            Download Resume
          </a>
        </div>
